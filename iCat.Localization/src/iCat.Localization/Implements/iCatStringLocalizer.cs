...
namespace iCat.Localization.Implements
{
    ...
    /// </summary>
    public class iCatStringLocalizer : IiCatStringLocalizer
    {
        /// <summary>
        /// <inheritdoc/>
        /// </summary>
        ...
        private readonly IiCatLocalizationDataProvider _localizationDataProvider;
        private readonly Options _options;

        public iCatStringLocalizer(IiCatLocalizationDataProvider localizationDataProvider, Options? options = null)
        {
